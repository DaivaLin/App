    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (Situation){
            case "food":
                ...
                imgIds = new int[]{R.drawable.bird, R.drawable.chicken, R.drawable.fish, R.drawable.water, R.drawable.cold, R.drawable.hot, R.drawable.coffee, R.drawable.tea, R.drawable.not_thing, R.drawable.what, R.drawable.not_thing, R.drawable.not_thing, R.drawable.tasty, R.drawable.not_thing, R.drawable.not_thing, R.drawable.not_thing, R.drawable.not_thing, R.drawable.milk, R.drawable.meat, R.drawable.egg, R.drawable.dish, R.drawable.dumpling, R.drawable.rice, R.drawable.noodles, R.drawable.soup, R.drawable.bun, R.drawable.cake, R.drawable.bread, R.drawable.fruits, R.drawable.apple, R.drawable.banana, R.drawable.food, R.drawable.drink, R.drawable.juice, R.drawable.wine, R.drawable.cup, R.drawable.cup, R.drawable.not_thing, R.drawable.eat, R.drawable.drinking, R.drawable.not_thing, R.drawable.not_thing, R.drawable.sweet, R.drawable.menu, R.drawable.chocolate, R.drawable.not_thing, R.drawable.plate1, R.drawable.bowl, R.drawable.plate, R.drawable.piece, R.drawable.bottle, R.drawable.not_thing, R.drawable.half, R.drawable.not_thing, R.drawable.good, R.drawable.meal, R.drawable.seat, R.drawable.oil, R.drawable.not_thing, R.drawable.health, R.drawable.i_am_done, R.drawable.i_am_done, R.drawable.steak, R.drawable.rice2, R.drawable.sandwich, R.drawable.watermelon, R.drawable.beer, R.drawable.black_tea, R.drawable.order, R.drawable.not_thing, R.drawable.package2, R.drawable.sour, R.drawable.bitter, R.drawable.salty, R.drawable.spicy, R.drawable.dessert, R.drawable.ice_cream, R.drawable.cookie, R.drawable.hamburg, R.drawable.vegetables, R.drawable.salt, R.drawable.sugar, R.drawable.cook, R.drawable.not_thing, R.drawable.not_thing, R.drawable.not_thing, R.drawable.mouth, R.drawable.not_thing, R.drawable.not_thing, R.drawable.not_thing, R.drawable.not_thing, R.drawable.not_thing, R.drawable.not_thing, R.drawable.not_thing, R.drawable.not_thing, R.drawable.grilled, R.drawable.not_thing, R.drawable.package1, R.drawable.knife, R.drawable.fork, R.drawable.spoon, R.drawable.chopsticks};
