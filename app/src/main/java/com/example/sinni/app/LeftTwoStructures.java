...
//左二右一結構
public class LeftTwoStructures extends AppCompatActivity {
    ...
    public void Refresh() {
        //自己调到自己的activity
        //  finish();
        Intent intent  = new Intent(LeftTwoStructures.this, LeftTwoStructures.class);
