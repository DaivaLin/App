...
//上中下結構
public class OnTheLowerStructure extends AppCompatActivity {
    ...
    public void Refresh() {
        //自己调到自己的activity
        //  finish();
        Intent intent  = new Intent(OnTheLowerStructure.this, OnTheLowerStructure.class);
