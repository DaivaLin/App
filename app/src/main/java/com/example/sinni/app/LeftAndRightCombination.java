...
public class LeftAndRightCombination extends AppCompatActivity {
  ...
  /*  public void showToastMessage(String text, int duratin){
    ...
    private void SetStart() {
        AlertDialog.Builder builder = new AlertDialog.Builder(LeftAndRightCombination.this);
    ...
    public void Refresh() {
        //自己调到自己的activity
        //  finish();
        Intent intent  = new Intent(LeftAndRightCombination.this, LeftAndRightCombination.class);
