...
public class LeftThreePacks extends AppCompatActivity {
    //左三包字判斷
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        re.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(LeftThreePacks.this,StructureTeaching.class);
    ...
    public void Ltp(View v){
        ...
        if(a==0){
            if(!(mx >= 250 && mx <= 450 && my >= 115 && my <= 305)){
    ...
    private void SetStart() {
        AlertDialog.Builder builder = new AlertDialog.Builder(LeftThreePacks.this);
    ...
    public void Refresh() {
        //自己调到自己的activity
        //  finish();
        Intent intent  = new Intent(LeftThreePacks.this,LeftThreePacks.class);
