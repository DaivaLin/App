...
public class OnTheThreeBags extends AppCompatActivity {
    //上三包字判斷
    ...
    //上三包字判斷
    public void Ott(View v){
        backgroundImageName = String.valueOf(v.getTag());
        if(a==0){
            if(!(mx >= 150 && mx <= 350 && my >= 210 && my <= 400)){
    ...
    private void SetStart() {
        AlertDialog.Builder builder = new AlertDialog.Builder(OnTheThreeBags.this);
    ...
    public void Refresh() {
        //自己调到自己的activity
        //  finish();
        Intent intent  = new Intent(OnTheThreeBags.this,OnTheThreeBags.class);
