...
public class LeftLowerPack extends AppCompatActivity {
    //向右上包字
    ...
    Button re;
        ...
        private void SetStart() {
            AlertDialog.Builder builder = new AlertDialog.Builder(LeftLowerPack.this);
        ...
        public void Refresh() {
            //自己调到自己的activity
            //  finish();
            Intent intent  = new Intent(LeftLowerPack.this,LeftLowerPack.class);
