...
//上二下一結構
public class OnTheNextOneStructures extends AppCompatActivity {
    ...
    public void Otnos(View v){
        backgroundImageName = String.valueOf(v.getTag());
        if(a==0){
            if(mx >= 50 && mx <= 250 && my >= 20 && my <= 210) {
    ...
    public void Refresh() {
        //自己调到自己的activity
        //  finish();
        Intent intent  = new Intent(OnTheNextOneStructures.this, OnTheNextOneStructures.class);
