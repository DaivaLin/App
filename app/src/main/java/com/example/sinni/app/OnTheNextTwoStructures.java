...
//上一下二結構
public class OnTheNextTwoStructures extends AppCompatActivity {
    ...
    public void Refresh() {
        //自己调到自己的activity
        //  finish();
        Intent intent  = new Intent(OnTheNextTwoStructures.this, OnTheNextTwoStructures.class);
