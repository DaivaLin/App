...
//左一右二結構
public class LeftAndRightTwoStructures extends AppCompatActivity {
    ...
    public void Ottb(View v){
        backgroundImageName = String.valueOf(v.getTag());
        if(a==0){
            if(mx >= 50 && mx <= 250 && my >= 20 && my <= 400) {
    ...
    public void Refresh() {
        //自己调到自己的activity
        //  finish();
        Intent intent  = new Intent(LeftAndRightTwoStructures.this, LeftAndRightTwoStructures.class);
