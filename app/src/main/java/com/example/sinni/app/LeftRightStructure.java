...
public class LeftRightStructure extends AppCompatActivity {
    ...
    public void Refresh() {
        //自己调到自己的activity
        //  finish();
        Intent intent  = new Intent(LeftRightStructure.this, LeftRightStructure.class);
