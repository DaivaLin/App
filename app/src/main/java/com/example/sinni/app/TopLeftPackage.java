...
public class TopLeftPackage extends AppCompatActivity {
    //向右下包字判斷
    int[] animationword =new int[]{};
    int[][] animationword1 = new int[][]{{}};
    int[][] animationword2= new int[][]{{}};

    // int[][][] animationword2 = new int[][][]{{{R.raw.animationword4},{R.drawable.first10, R.drawable.first11, R.drawable.first12, R.drawable.first13},{R.drawable.part1,R.drawable.part5,R.drawable.part1}}};
    //上下字
    //int[][][] animationword3 = new int[][][]{{{R.raw.animationword5},{R.drawable.first14, R.drawable.first15, R.drawable.first16},{R.drawable.part2,R.drawable.part0}},{{R.raw.animationword6},{R.drawable.first21, R.drawable.first22,R.drawable.first23},{R.drawable.part8,R.drawable.part7}}};
    //上下字
    //int[][][] animationword4 = new int[][][]{{{R.raw.animationword7},{R.drawable.first17, R.drawable.first18, R.drawable.first20,R.drawable.first21},{R.drawable.part4,R.drawable.part3,R.drawable.part13}}};
    ...
    //左上包字判斷
    public void Tlp(View v){
        backgroundImageName = String.valueOf(v.getTag());
        if(a==0){
            if(!(mx >= 250 && mx <= 450 && my >= 210 && my <= 400)){
    ...
    private void SetStart() {
        AlertDialog.Builder builder = new AlertDialog.Builder(TopLeftPackage.this);
    ...
    public void Refresh() {
        //自己调到自己的activity
        //  finish();
        Intent intent  = new Intent(TopLeftPackage.this,TopLeftPackage.class);
