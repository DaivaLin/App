...
public class RightUpperPackage extends AppCompatActivity {
    //向左下包字判斷
  ...
  String  Situation;
    ...
    private void SetStart() {
        AlertDialog.Builder builder = new AlertDialog.Builder(RightUpperPackage.this);
    ...
    public void Refresh() {
        //自己调到自己的activity
        //  finish();
        Intent intent  = new Intent(RightUpperPackage.this,RightUpperPackage.class);
